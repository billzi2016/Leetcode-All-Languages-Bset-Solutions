...
- Ollama 调用参数测试：确认单次语言生成的最大输出限制为 100_000 tokens，温度为 `0.1`。
...
- 能按 `Leetcode-Easy/0001-0100/0001-two-sum.md` 结构落盘。
- 能展示难度进度条和语言子进度条。
...
- Ollama client 测试覆盖 `ollama` 库调用、三种 think 模式、100_000 tokens 输出限制和温度 `0.1`。
